...
ShipPreviewWindow::ShipPreviewWindow(
    ...
    , mWaitBitmap(WxHelpers::MakeBitmap(GameAssetManager::LoadPngImageRgba(gameAssetManager.GetPngImageFilePath("ship_preview_wait"))))
    , mErrorBitmap(WxHelpers::MakeBitmap(GameAssetManager::LoadPngImageRgba(gameAssetManager.GetPngImageFilePath("ship_preview_error"))))
    , mPreviewRibbonBatteryBitmap(WxHelpers::MakeBitmap(GameAssetManager::LoadPngImageRgba(gameAssetManager.GetPngImageFilePath("ship_preview_ribbon_battery"))))
    , mPreviewRibbonHDBitmap(WxHelpers::MakeBitmap(GameAssetManager::LoadPngImageRgba(gameAssetManager.GetPngImageFilePath("ship_preview_ribbon_hd"))))
    , mPreviewRibbonBatteryAndHDBitmap(WxHelpers::MakeBitmap(GameAssetManager::LoadPngImageRgba(gameAssetManager.GetPngImageFilePath("ship_preview_ribbon_battery_and_hd"))))
    //
    , mPollQueueTimer()
    , mInfoTiles()
    , mSelectedShipFileId()
